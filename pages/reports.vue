<template>
  <div class="lg:h-[100vh] lg:min-h-[800px] w-full  flex flex-col  gap-8 items-start justify-start  bg-neutral-800 p-6" >
    <header :class="[
      'w-full ',
...
// revenue_chart_options.value.chart.reflow()
</script>
